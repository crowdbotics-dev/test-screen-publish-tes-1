"""
Django settings for test_screen_publish_tes_1 project.
...
ROOT_URLCONF = 'test_screen_publish_tes_1.urls'
...
WSGI_APPLICATION = 'test_screen_publish_tes_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_screen_publish_tes_1 API",
    "DESCRIPTION": "API documentation for test_screen_publish_tes_1 App",
    "VERSION": "v1",
}
