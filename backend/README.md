...
## Project Structure
    ...
    ├── test_screen_publish_tes_1  # Django project configurations
...
1. Clone this repo and `cd test_screen_publish_tes_1`
...
2. Clone this repo and `cd test_screen_publish_tes_1`
